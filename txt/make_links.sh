...
link_block() {
	#echo "link_block $1 $2"
	link ${textures_path}/blocks/$1 $2
}

# a linking function for items
link_item() {
	#echo "link_item $1 $2"
	link ${textures_path}/items/$1 $2
}
...
link_item hatchetGold default_tool_meseaxe
...
link_item iron_hoe farming_hoe_iron
...
link_item pickaxeGold default_tool_mesepick
...
link_item shovelGold default_tool_meseshovel
...
link_item stone_hoe farming_hoe_stone
...
link_item string default_string
link_item swordDiamond default_tool_diamondsword
link_item swordGold default_tool_mesesword
...
link_item wood_hoe farming_hoe_wood
...
link_block brick default_brick
...
link_block ladder default_ladder
...
link_block rail default_rail
link_block rail_normal default_rail
link_block rail_turn default_rail_curved
...
link_block stonebrick default_cobble
link_block stonebrick default_stonebrick
...
link_block tnt_bottom default_tnt_bottom
link_block tnt_side default_tnt_side
link_block tnt_top default_tnt_top
